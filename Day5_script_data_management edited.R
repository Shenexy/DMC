...
table(agric_gender$gender, agric_gender$location)
chisq.test(table(agric_gender$gender, agric_gender$location))

table(agric_gender$Crop_Type, agric_gender$location)
chisq.test(table(agric_gender$Crop_Type, agric_gender$location))
